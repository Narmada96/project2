     ...
     <div class="content">
      ...
      <div class="form-group">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10">
                                          <input type="text" class="form-control" name="supplier_company_name" value="{{$supplier->supplier_company_name}}" required>
                                          </div>
                                        </div>
                                        ...
                                        <label class="control-label col-sm-2" for="projectnamelbl">Name of contact person:</label>
                                          <div class="col-sm-10">
                                          <input type="text" class="form-control" name="name_of_contact_person" value="{{$supplier->name_of_contact_person}}" required>
                                        ...
                                        <div class="form-group">
                                          <label class="control-label col-sm-2" for="customercontactlbl">Contact number:</label>
                                            <div class="col-sm-10">
                                            <input type="text" class="form-control" name="supplier_contact_number" value="{{$supplier->supplier_contact_number}}"  required>
                                        ...
                                        <label class="control-label col-sm-2" for="projectnamelbl">Address:</label>
                                          <div class="col-sm-10">
                                          <input type="text" class="form-control" name="supplier_address" value="{{$supplier->supplier_address}}" required>
                                        ...
                                        <div class="form-group">
                                              ...
                                              <div class="col-sm-10">
                                                <input type="text" placeholder="Hired date" onfocus="(this.type='date')" onblur="(this.type='text')" name="hired_date" value="{{$supplier->hired_date}}" required>  
                                          </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-sm-10">
                                                <input type="text" placeholder="Estimated work end date" onfocus="(this.type='date')" onblur="(this.type='text')" name="estimated_work_end_date" value="{{$supplier->estimated_work_end_date}}" required>  
                                          </div>
                                          </div>
