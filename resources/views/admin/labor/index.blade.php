...
<div style="overflow-x:auto;">
           <table class="table table-bordered table-striped" id="labor_table">
                                                  ...
                                                  <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{$l->supplier_id}}</td>
                                                        <td>{{$l->supplier_details}}</td>
                                                        <td>{{$l->labor_nic}}</td>
                                                        <td>{{$l->first_name}}</td>
                                                        <td>{{$l->last_name}}</td>
                                                        <td>{{$l->labor_type}}</td>
                                                        <td>{{$l->labor_category}}</td>
                                                        <td>{{$l->designation}}</td>
                                                        <td>{{$l->labor_contact_number}}</td>
                                                        <td>{{$l->labor_availability}}</td>
                                                        <td>{{$l->labor_hired_date}}</td>
                                                        <td>{{$l->labor_end_date}}</td>
                                                        <td> <div class="btn-group" role="group">
                                                        <a href="{{route('admin.labor.edit', $l->labor_nic)}}" class="btn btn-info"> Edit  </a> 
                                                        <a href="{{route('admin/labor/{labor_nic}/allocationEdit',$l->labor_nic)}}" class="btn btn-warning" > Allocate </a>
                                                        </div>
                                                        </td>
