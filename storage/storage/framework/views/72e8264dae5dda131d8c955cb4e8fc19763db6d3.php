...
<div class="content-header">
     ...
     <div class="content">
      ...
      <form class="form-horizontal" action="<?php echo e(route('admin.warranties.store')); ?>"  method="POST">
      ...
      <div class="form-group">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10">
                                            ...
                                            <option value ="" disabled selected> Choose your option </option> 
                                            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($p->project_id); ?> <?php echo e($p->project_name); ?> <?php echo e($p->project_location); ?>"> <?php echo e($p->project_id); ?> - <?php echo e($p->project_name); ?> , <?php echo e($p->project_location); ?> </option> 
                                          ...
                                          <option value ="" disabled selected> Choose your option </option> 
                                            ...
                                            <option value="<?php echo e($c->customer_id); ?> <?php echo e($c->company_name); ?>"> <?php echo e($c->customer_id); ?> - <?php echo e($c->company_name); ?> </option> 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\project2\resources\views/admin/warranties/create.blade.php ENDPATH**/ ?>