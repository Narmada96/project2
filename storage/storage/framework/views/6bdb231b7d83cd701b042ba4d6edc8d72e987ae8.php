...
<div class="content-header">
     ...
     <div class="content">
      ...
      <div class="form-group">
                                          ...
                                          <div class="col-sm-10">
                                            <input type="text" class="form-control" name="employee_nic" value="<?php echo e($allocations->allocation_id); ?>" required>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10">
                                            <input type="text" class="form-control" name="first_name" required value="<?php echo e($allocations->first_name); ?>">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10">
                                            <input type="text" class="form-control" name="last_name" required value="<?php echo e($allocations->last_name); ?>">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10">
                                            <select class="form-control" name="employee_type" required value="<?php echo e($allocations->employee_type); ?>">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                              <input type="radio" name="employee_availability" value="<?php echo e($employee->employee_availability); ?>">Not available</label>
                                              &nbsp &nbsp &nbsp &nbsp 
                                            <label class="radio-inline">
                                              <input type="radio" name="employee_availability" value="<?php echo e($employee->employee_availability); ?>">Available</label>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            <label class="control-label col-sm-2" for="projectidlbl">Project ID:</label>
                                              <div class="col-sm-10">
                                              <input type="text" class="form-control" name="project_id" value="<?php echo e($employee->project_id); ?>">
                                              </div>
                                            </div>
                                            ...
                                            <label class="control-label col-sm-2" for="projectnamelbl">Project name:</label>
                                              <div class="col-sm-10">
                                              <input type="text" class="form-control" name="project_name" value="<?php echo e($employee->project_name); ?>">
                                              </div>
                                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\project2\resources\views/admin/allocation/create.blade.php ENDPATH**/ ?>